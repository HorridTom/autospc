...
If you want to make a change, it’s a good idea to first file an issue
and make sure someone from the team agrees that it’s needed. If you’ve
...
help you write a unit test, if needed). There’s some really useful
guidance on this here: [how to create a great
...
with contributors outside the team.
...
- Create a Git branch for your pull request (PR). We recommend using
  ...
  “bugfix-brief-description-issueno” or
  “feature-brief-description-issueno”, where “issueno” is the GitHub
  issue number.
...
- We use [renv](https://horridtom.github.io/autospc/) for dependency
  management. If your changes modifies dependencies, please discuss with
  us first, and be sure to
  [`renv::snapshot()`](https://rstudio.github.io/renv/reference/snapshot.html)
  to capture the changes.

## Code of Conduct

Please note that the autospc project is released with a [Contributor
Code of
Conduct](https://horridtom.github.io/autospc/CODE_OF_CONDUCT.md). By
