...
#' "auto" - display a floating median if and only if there are sufficient data
#' to form a median, and at least one point that is part of a shift rule break
#' in the final floating_median_n data points on the chart.
#' @param floating_median_n The number of points to use for calculation of the
#' floating median, if present. Where the series holds fewer non-missing points
#' than this, there are none to take a median over, so none is drawn: "yes"
#' warns, and "auto" is silent.
