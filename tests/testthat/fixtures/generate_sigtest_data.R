...
make_data_column_validation_data <- function() {
  ...
  saveRDS(
    data_column_validation_expected_conditions_yn,
    file.path(
      "tests",
      "testthat",
      "testdata",
  ...
  saveRDS(
    data_column_validation_expected_conditions_y,
    file.path(
      "tests",
      "testthat",
      "testdata",
