...
test_that("the default y axis range is a percentage scale", {
  ...
  expect_identical(
    y_axis_range(bare_chart, data = limits_data),
    list(low = 0, high = 110)
  )
})
...
test_that("the default centre line label separates thousands", {
  ...
  expect_identical(
    centre_line_label(chart, cl = 12217, ylimhigh = 20000),
    "12,217"
  )
})
