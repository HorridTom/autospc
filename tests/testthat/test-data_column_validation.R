...
expected_conditions <- list(
  y_missing_p = list(
    kind = "error",
    text = paste0(
      "y not specified. For P and P' charts, y must be ",
      "specified."
    )
  ),
  y_type_p = list(
  ...
  y_not_logical_p = list(
    kind = "error",
    text = paste0(
      "n is not specified and y is not of type logical. For P ",
  ...
  n_rounded_p = list(
    kind = "warning",
    text = paste0(
      "At least one element of n has non-zero fractional part. ",
      "Rounding to the nearest whole number.\n",
  ...
  y_missing_x = list(
    kind = "error",
    text = paste0(
      "y not specified. For X, MR and XMR charts, y must be ",
      "specified."
    )
  ),
  y_type_x = list(
...
test_that("a P chart with an invalid n column errors without warning first", {
  ...
  expect_no_warning(
    expect_error(
      autospc_chart(
        chart_type = "P", data = bad_denominator,
        x = "x", y = "y", n = "n"
      ),
