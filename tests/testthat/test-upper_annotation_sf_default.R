...
label_data <- data.frame(x = 1:30,
                         y = rep(c(12000L, 12500L, 11800L,
                                   13000L, 12200L, 12700L), 5L))

label_p_data <- data.frame(x = 1:30,
...
stepped_data <- data.frame(x = 1:70,
                           y = c(rep(c(120L, 140L, 110L, 150L, 130L), 7L),
