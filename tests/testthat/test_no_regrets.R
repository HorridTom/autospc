...
test_that("No regrets = TRUE",{
  ...
  output_no_regrets <- autospc::autospc(test_data, noRegrets = T, chartType = "C'", plotChart = F)
  output_no_regrets2 <- autospc::autospc(test_data2, noRegrets = T, chartType = "C'", plotChart = F)
  output_no_regrets3 <- autospc::autospc(test_data3, noRegrets = T, chartType = "C'", plotChart = F)
  output_no_regrets4 <- autospc::autospc(test_data4, noRegrets = T, chartType = "C'", plotChart = F)
  output_no_regrets5 <- autospc::autospc(test_data5, noRegrets = T, chartType = "C'", plotChart = F)
...
test_that("No regrets = FALSE",{
  ...
  output_regrets <- autospc::autospc(test_data, noRegrets = F, chartType = "C'", plotChart = F)
  output_regrets2 <- autospc::autospc(test_data2, noRegrets = F, chartType = "C'", plotChart = F)
  output_regrets3 <- autospc::autospc(test_data3, noRegrets = F, chartType = "C'", plotChart = F)
  output_regrets4 <- autospc::autospc(test_data4, noRegrets = F, chartType = "C'", plotChart = F)
  output_regrets5 <- autospc::autospc(test_data5, noRegrets = F, chartType = "C'", plotChart = F)
