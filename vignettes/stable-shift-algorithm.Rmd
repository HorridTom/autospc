...
candidate calculation period. Figure \@ref(fig:example-4) shows a different
...
If the rule break only reaches the `runRuleLength` threshold after the end of
the candidate calculation period, it is referred to as an
*overhanging reversion*.
